...
TEST(PrimaryKeyRealtimeOptionsTest, TestUnsupportedOptions) {
    ...
    const std::vector<std::map<std::string, std::string>> unsupported_options = {
        ...
        {{Options::BUCKET, "1"}, {Options::IGNORE_DELETE, "true"}},
        {{Options::BUCKET, "1"}, {Options::PARTIAL_UPDATE_REMOVE_RECORD_ON_DELETE, "true"}},
        {{Options::BUCKET, "1"}, {Options::AGGREGATION_REMOVE_RECORD_ON_DELETE, "true"}},
        {{Options::BUCKET, "1"},
